...
export default function Appreance() {
  ...
  return (
    <button onClick={switchTheme}>
      {Theme === "autumn" ? (
        <div className="z-30 top-[90%] bg-slate-900 outline outline-2 outline-offset-[-4px] text-white left-[93%] p-1 fixed rounded-full flex">
        ...
        <div className="z-30 top-[90%] bg-white outline outline-2 outline-offset-[-4px] text-slate-900 left-[93%] p-1 fixed rounded-full flex">
